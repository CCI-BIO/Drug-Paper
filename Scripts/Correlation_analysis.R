...
cohort_solid<-id[id$`Tumor type` !="HM",] # 108 solid tumor samples
...
## Drug efficacy data
FileA <- "InVitro_DrugResponseDatabase_MASTER_20220812_Complete.xlsx"
...
## Gene expression TPM 
tpm<-read.delim("./ExpressionAnalysis/GeneExpression_TPM_Counts.txt",check.names = F)
