...
# Inputs: 
# InVitro_DrugInformationWorksheet.xlsx
# InVitro_DrugResponseDatabase.xlsx

# Outputs:
# Volcano_Merged_AUC_IC50.csv

library(xlsx)
library(readxl)

# drugs metadata
DrugInfo <- read.xlsx("InVitro_DrugInformationWorksheet.xlsx", "Compounds_MergedOverview")
...
id<-as.data.frame(read_excel("InVitro_DrugResponseDatabase.xlsx", sheet="RNA_batch"))
